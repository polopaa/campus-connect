import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, u as useAuth, a as useNavigate, b as Card, d as CardContent, B as Button } from "./index-BFj2ryNh.js";
...
function LoginPage() {
  ...
  const [signupSuccess, setSignupSuccess] = reactExports.useState(false);
  reactExports.useEffect(() => {
    if (isAuthenticated) {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -bottom-32 -right-32 w-80 h-80 rounded-full bg-accent/10 blur-3xl" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center mb-8 gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 rounded-2xl bg-primary flex items-center justify-center shadow-elevated", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  GraduationCap,
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl font-bold text-foreground tracking-tight", children: "CampusConnect" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-1", children: "Find students from your home state or city" })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border border-border shadow-card bg-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-8 pb-7 px-7", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex rounded-lg bg-muted p-1 mb-6", role: "tablist", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      ...
                      className: `flex-1 rounded-md py-1.5 text-sm font-medium transition-colors ${tab === "signin" ? "bg-card text-foreground shadow-sm" : "text-muted-foreground hover:text-foreground"}`,
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      ...
                      className: `flex-1 rounded-md py-1.5 text-sm font-medium transition-colors ${tab === "signup" ? "bg-card text-foreground shadow-sm" : "text-muted-foreground hover:text-foreground"}`,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-4", noValidate: true, children: [
                  ...
                  signupSuccess && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-xs text-muted-foreground mt-6", children: "By signing in you agree to our community guidelines." })
            ]
          }
        )
      ]
